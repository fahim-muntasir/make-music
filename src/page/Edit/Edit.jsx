    ...
    return (
        <div style={{ backgroundImage: `url(${bg})`, backgroundSize: 'cover' }} className='bg-no-repeat pb-20' >
            <div className='max-w-7xl mx-auto'>
                <h1 className='text-2xl font-semibold mt-5 font-poppins'>Edit song</h1>
                <div className='mt-4'>
                    <div className='flex bg-[#8A97DA] h-24 items-center rounded-md justify-between'>
                        <div className='flex items-center'>

                            <input type="text" className='ml-8 py-5 px-80 rounded-md outline-none' />
                        </div>
                        <div className='mr-8'>
                            ...
                            <button className='px-9 py-2 text-white font-poppins text-lg hover:bg-[#4BCE9C] rounded border border-[#4BCE9C] mx-3'>Save</button>
                        </div>
                    </div>
                </div>
                ...
                <div className='my-8 flex'>
                    <div className='w-14'>
                        <h1 className='text-xl font-semibold font-poppins'>Type</h1>
                    </div>
                    <div className='grid grid-cols-4 w-full'>
                        <div
                            className={`px-9 py-2 text-lg font-poppins text-center cursor-pointer  border border-[#8A97DA] ${activeButton === 'Guitar' ? 'bg-[#8A97DA] text-white' : ''}`}
                            onClick={() => handleButtonClick('Guitar')} >  Guitar </div>
                        <div
                            className={`px-9 py-2 text-center cursor-pointer text-lg font-poppins border-l-0  border border-[#8A97DA] ${activeButton === 'Piano' ? 'bg-[#8A97DA] text-white' : ''}`}
                            onClick={() => handleButtonClick('Piano')} > Piano</div>
                        <div
                            className={`px-9 py-2 text-center cursor-pointer border-l-0 text-lg font-poppins  border border-[#8A97DA] ${activeButton === 'Violin' ? 'bg-[#8A97DA] text-white' : ''}`}
                            onClick={() => handleButtonClick('Violin')}>Violin</div>
                        <div
                            className={`px-9 py-2 text-center cursor-pointer text-lg font-poppins border-l-0  border border-[#8A97DA] ${activeButton === 'Drums' ? 'bg-[#8A97DA] text-white' : ''}`}
